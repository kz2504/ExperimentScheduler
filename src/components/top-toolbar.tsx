...
export function TopToolbar({
  ...
  const panelClassName = "min-w-0 rounded-2xl border border-border/60 bg-white/72 p-3";
  ...
  return (
    <Card className="glass-panel mb-4 overflow-hidden border-border/70 shadow-panel">
      <CardContent className="space-y-4 p-4">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-[11px] font-semibold uppercase tracking-[0.28em] text-cyan-700/80">
        ...
        <div className="grid gap-3 2xl:grid-cols-[minmax(0,1.15fr),minmax(320px,0.85fr)]">
          ...
          <div className="grid gap-3 lg:grid-cols-[minmax(0,1fr),220px]">
            ...
            <div className={`flex min-w-0 flex-col gap-3 ${panelClassName}`}>
              <Label>Rows</Label>
              <Button size="sm" className="justify-start" onClick={() => addRow("syringe")}>
                <Plus className="h-4 w-4" />
                Add Channel
              </Button>
              <div className="rounded-xl border border-border/60 bg-slate-50/85 px-3 py-2 text-xs text-muted-foreground">
